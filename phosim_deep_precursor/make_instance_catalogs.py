...
from desc.twinkles.InstcatGenerator import InstcatFactory
...
# The Twinkles field.
fieldID = 1427
boundLength = 2  # radius of extraction region in degrees
...
band = 'r'
for obsHistID in obsHistIDs[:1]:
    outfile = 'phosim_input_%s_%07i_2deg.txt' % (band, obsHistID)

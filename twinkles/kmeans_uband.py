...
# Find all of the light curves with chisq > 1e5
query = 'select objectId from Chisq where dof=252 and chisq>1e5'
object_ids = jc_desc.apply(query, lambda curs : [x[0] for x in curs])
